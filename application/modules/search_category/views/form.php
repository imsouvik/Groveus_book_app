<div class="heading">
    <ol class="breadcrumb">
      ...
      <li><a href="javascript:void(0)">Search Category</a></li>
    </ol>
</div>
     ...
     <div class="col-sm-6">
         ...
         <input name="id" ng-model="x.menu_id" hidden>
          <div class="clearfix"></div><br>
            ...
            <div class="col-sm-12 ">
                <div class="col-sm-6 ">
                    <label class="deco">Search Category Name</label>
                    <input name="search_category" class="form-control" ng-model="y.search_category"   required style="width:400px;">               
                </div>
             </div>
 			<div class="clearfix"></div><br>
 			<div class="col-sm-12">
